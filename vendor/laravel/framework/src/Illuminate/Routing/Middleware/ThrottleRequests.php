...
class ThrottleRequests
{
     ...
     */
    public static function with($maxAttempts = 10000, $decayMinutes = 0, $prefix = '')
    {
     ...
     */
    public function handle($request, Closure $next, $maxAttempts = 12000, $decayMinutes = 0, $prefix = '')
    {
